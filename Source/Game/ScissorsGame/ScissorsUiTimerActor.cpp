#include "pch.h"
#include "ScissorsUiTimerActor.h"
...
void ScissorsUiTimerActor::Initialize(const Transform& transform)
{
    ...
    timerOnesUi = std::make_shared<UIImageComponent>("./Data/Textures/ScissorsUI/number.png", "timer_ones_number");
    ...
    timerTensUi = std::make_shared<UIImageComponent>("./Data/Textures/ScissorsUI/number.png", "timer_tens_number");
...
void ScissorsUiTimerActor::Update(float elapsedTime)
{
...
void ScissorsUiTimerActor::DrawImGuiDetails()
{
#ifdef USE_IMGUI
...
void ScissorsUiTimerActor::Play()
{
...
// 残り５秒のタイマーの動き
void ScissorsUiTimerActor::StartTimerShake()
{
    shakeTimer = 0.0f;
    isShaking = true;
}