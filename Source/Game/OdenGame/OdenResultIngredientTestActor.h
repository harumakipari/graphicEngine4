...
// 　リザルトで描画する食材
//
class OdenResultIngredientTestActor :public Actor
{
public:
    explicit OdenResultIngredientTestActor(const std::string& actorName, const std::string& ingredientName) :Actor(actorName), ingredientName(ingredientName) {}
