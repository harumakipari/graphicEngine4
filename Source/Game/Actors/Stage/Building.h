...
public:
    ...
    void OnHit(std::pair<CollisionComponent*, CollisionComponent*> hit_pair)override;
    ...
    float GetDissolveRate() const { return (convexTimer - deactivateTime) / convexTimer; }

    bool GetDestroy() const { return hp <= 0; }
