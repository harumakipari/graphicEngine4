...
#else
    return float4(step(bloom_extraction_threshold /*ñæÇÈÇ¢Ç∆Ç±ÇÎÇÃäÓèÄíl*/, max(sampled_color.r, max(sampled_color.g, sampled_color.b))) * sampled_color.rgb, sampled_color.a);
#endif	
}
